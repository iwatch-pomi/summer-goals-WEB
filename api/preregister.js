...
export function buildConfirmationMail(to, fromUser) {
  const text = [
    ...
    'SummerGoals とは',
    '━━━━━━━━━━━━━━━━━━',
    '8月12日〜9月10日の30日間、平日に証拠写真で報告して',
    '完走すれば、預けた継続保証金3,000円が全額返金される、',
    '大学生のための習慣化プログラムです。',
    '',
    '・8月12日〜9月10日 開催（30日間・一斉スタート）',
    '・土日はお休みOK（報告は平日22日間／失効は最大2,200円）',
  ...
  <div style="font-family:'Hiragino Kaku Gothic ProN','Noto Sans JP',sans-serif; color:#15314b; line-height:1.8; max-width:520px;">
    ...
    <div style="border:1px solid #e3eef5; border-top:none; padding:22px 24px; border-radius:0 0 14px 14px;">
      ...
      <p style="margin:0 0 14px; font-size:14px;">8月12日〜9月10日の30日間、平日に証拠写真で報告して完走すれば、預けた継続保証金3,000円が全額返金される、大学生のための習慣化プログラムです。</p>
      <ul style="margin:0 0 16px; padding-left:20px; font-size:14px;">
        <li>8月12日〜9月10日 開催（30日間・一斉スタート）</li>
        <li><b>土日はお休みOK</b>（報告は平日22日間／失効は最大2,200円）</li>
